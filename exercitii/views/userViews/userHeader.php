...
//<p style="color: #f2f2f2">Welcome, ' . findUserById($_COOKIE['userID'], $receivedUsers)->name .'</p>
echo '<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link ' . addStyleToCurrentPage($currentPage, "userView.php", NAV_LINK_ACTIVE_CSS_CLASS) . '" href="userView.php">Shop</a>
                </li>'
                . addPageToHeaderIfItIsCurrentPage($currentPage, "orderConfirm.php", "Confirm Order") .
